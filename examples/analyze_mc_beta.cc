...
void analyze_qcd_beta(MOD::Event & event_being_read, ofstream & output_file, int & event_serial_number, vector<double> cone_radii, vector<double> pt_cuts) {
   ...
   PseudoJet soft_drop_jet_10 = soft_drop_10(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_11 = soft_drop_11(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_12 = soft_drop_12(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_13 = soft_drop_13(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_14 = soft_drop_14(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_15 = soft_drop_15(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_16 = soft_drop_16(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_17 = soft_drop_17(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_18 = soft_drop_18(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_19 = soft_drop_19(hardest_reco_jet);
   ...
   PseudoJet soft_drop_jet_20 = soft_drop_20(hardest_reco_jet);
   ...
   vector<fastjet::PseudoJet> charged_constituents = MOD::filter_charged(hardest_reco_jet_constituents);
