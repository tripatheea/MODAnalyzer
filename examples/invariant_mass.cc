...
void invariant_mass(MOD::Event & event_being_read, ofstream & output_file);
...
int main(int argc, char * argv[]) {
   ...
   output_file << "# Entries  invariant_mass  corrected_invariant_mass  prescale" << endl;
   ...
   while( event_being_read.read_event(data_file) && ( event_serial_number <= number_of_events_to_process ) ) {
      ...
      invariant_mass(event_being_read, output_file);
