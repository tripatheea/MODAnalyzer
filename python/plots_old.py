...
def plot_zg_th_mc_data(pT_lower_cut=150, pT_upper_cut=10000, track=False, zg_cut='0.05', zg_filename='zg_05', ratio_denominator="theory", data=True, mc=True, theory=True, n_bins=10, y_max_limit=20, y_limit_ratio_plot=0.5):
	...
	for mc_type in ["truth"]:
		...
		if pT_upper_cut != 10000:
			labels = [r"$\mathrm{PFC}~pT > 500~\mathrm{MeV}$", "$ \\textrm{Anti--}k_{t}\\textrm{:}~R = 0.5$", "$p_{T} \in [" + str(pT_lower_cut) + ", " + str(pT_upper_cut) + "]~\mathrm{GeV};\eta<2.4$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = " + str(zg_cut) + "}$"]
		else:
			labels = [r"$\mathrm{PFC}~pT > 500~\mathrm{MeV}$", "$ \\textrm{Anti--}k_{t}\\textrm{:}~R = 0.5$", "$p_{T} > " + str(pT_lower_cut) + "~\mathrm{GeV};\eta<2.4$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = " + str(zg_cut) + "}$"]
			if track:
		...
		if track:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/track/z_g/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
		else:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/all/z_g/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
...
def plot_pts(pT_lower_cut=100, pT_upper_cut=10000):
	...
	for mc_type in ["truth"]:
		...
		plt.savefig("plots/" + get_version(input_analysis_file) + "/pT/" + mc_type + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + ".pdf")
		# plt.show()
		plt.close(plt.gcf())
...
def plot_charged_constituent_multiplicity_softdrop(pT_lower_cut=100, pT_upper_cut=20000):
	...
	for mc_label in ["truth", "reco"]:
		...
		extra = Rectangle((0, 0), 1, 1, fc="w", fill=False, edgecolor='none', linewidth=0)
		if pT_upper_cut != 20000:
			labels = [r"$ \textrm{Anti--}k_{t}\textrm{:}~R = 0.5$", r"$p_{T}\in[" + str(pT_lower_cut) + ", " + str(pT_upper_cut) + "]~\mathrm{GeV};\eta<2.4$", r"$ \textrm{Soft~Drop:}~\boldsymbol{\beta = 0;~z_{\mathrm{cut}} = 0.10}$"]
		else:
			labels = [r"$ \textrm{Anti--}k_{t}\textrm{:}~R = 0.5$", r"$p_{T} > " + str(pT_lower_cut) + "~\mathrm{GeV};\eta<2.4$", r"$ \textrm{Soft~Drop:}~\boldsymbol{\beta = 0;~z_{\mathrm{cut}} = 0.10}$"]
		plt.gca().legend([extra, extra, extra], labels, loc=7, frameon=0, borderpad=0.1, fontsize=60, bbox_to_anchor=[0.99, 0.58])
		...
		plt.savefig("plots/" + get_version(input_analysis_file) + "/charged_constituent_multiplicity_softdrop/" + mc_label + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_multiplicity.pdf")
		# plt.show()
		plt.close(plt.gcf())
...
def plot_fractional_pT_loss(pT_lower_cut=100, pT_upper_cut=20000):
	...
	for mc_type in ["truth", "reco"]:
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.21, 0.895), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
...
def plot_jet_mass_softdrop(pT_lower_cut=100, pT_upper_cut=20000):
	...
	for mc_label in ["truth"]:
		pythia_properties = parse_file("/home/aashish/pythia_" + mc_label + ".dat", pT_lower_cut=pT_lower_cut, pT_upper_cut=pT_upper_cut, keywords_to_populate=keywords)
		...
		if pT_upper_cut != 20000:
			labels = ["$ \\textrm{Anti--}k_{t}\\textrm{:}~R = 0.5$", "$p_{T}\in[" + str(pT_lower_cut) + ", " + str(pT_upper_cut) + "]~\mathrm{GeV};\eta<2.4$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = 0.10}$"]
		else:
			labels = ["$ \\textrm{Anti--}k_{t}\\textrm{:}~R = 0.5$", "$p_{T} > " + str(pT_lower_cut) + "~\mathrm{GeV};\eta<2.4$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = 0.10}$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = 0.10}$"]
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.24, 0.91), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
		...
		plt.savefig("plots/" + get_version(input_analysis_file) + "/jet_mass_softdrop/" + mc_label + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_jet_mass.pdf")
		# plt.show()
		plt.close(plt.gcf())
...
def plot_charged_jet_mass(pT_lower_cut=100, pT_upper_cut=20000):
	...
	for mc_label in ["truth", "reco"]:
		...
		if pT_upper_cut != 20000:
			labels = ["$ \\textrm{Anti--}k_{t}\\textrm{:}~R = 0.5;\eta<2.4$", "$p_{T}\in[" + str(pT_lower_cut) + ", " + str(pT_upper_cut) + "]~\mathrm{GeV}$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = 0.10}$"]
		else:
			labels = ["$ \\textrm{Anti--}k_{t}\\textrm{:}~R = 0.5;\eta<2.4$", "$p_{T} > " + str(pT_lower_cut) + "~\mathrm{GeV}$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = 0.10}$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = 0.10}$"]
		...
		plt.savefig("plots/" + get_version(input_analysis_file) + "/charged_jet_mass/" + mc_label + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_jet_mass.pdf")
		# plt.show()
		plt.close(plt.gcf())
...
def plot_jet_eta(pT_lower_cut=100):
	...
	for mc_type in ["truth"]:
		...
		pythia_properties = parse_file("/home/aashish/pythia_" + mc_type + ".dat", pT_lower_cut=pT_lower_cut, keywords_to_populate=keywords, eta_cut=6)
		herwig_properties = parse_file("/home/aashish/herwig_" + mc_type + ".dat", pT_lower_cut=pT_lower_cut, keywords_to_populate=keywords, eta_cut=6)
		sherpa_properties = parse_file("/home/aashish/sherpa_" + mc_type + ".dat", pT_lower_cut=pT_lower_cut, keywords_to_populate=keywords, eta_cut=6)
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.245, 0.90), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
...
def plot_theta_g_log_plots(pT_lower_cut=150, track=False, zg_cut='0.10', zg_filename='zg_10'):
	...
	for mc_type in ["truth"]:
		...
		if track:
			labels = ["Track Only", "$\mathrm{PFC}~pT > 500~\mathrm{MeV}$", "$ \\textrm{Anti--}k_{t}\\textrm{:}~R = 0.5$", "$p_{T} > " + str(pT_lower_cut) + "~\mathrm{GeV};\eta<2.4$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = " + str(zg_cut) + "}$"]
		else:
			labels = ["", "$\mathrm{PFC}~pT > 500~\mathrm{MeV}$", "$ \\textrm{Anti--}k_{t}\\textrm{:}~R = 0.5$", "$p_{T} > " + str(pT_lower_cut) + "~\mathrm{GeV};\eta<2.4$", "$ \\textrm{Soft~Drop:}~\\boldsymbol{\\beta = 0;~z_{\mathrm{cut}} = " + str(zg_cut) + "}$"]
		
		plt.gca().legend([extra] * len(labels), labels, loc=7, frameon=0, borderpad=0.1, fontsize=60, bbox_to_anchor=[0.52, 0.72])

		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.20, 0.91), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), logo_coords, xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.22, 0.895), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.23, 0.89), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
...
def plot_zg_theta_g_th_mc_data(pT_lower_cut=150, pT_upper_cut=10000, track=False, zg_cut='0.05', zg_filename='zg_05', ratio_denominator="data", data=True, mc=True, theory=True, n_bins=10, y_max_limit=20, y_limit_ratio_plot=0.5):
	...
	for mc_type in ["truth"]:
		...
		# 1 - ((1 - 0.895) * 21.429)/30
		if data:
			ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.27, 0.9249985), xycoords='figure fraction', frameon=0)
			plt.gca().add_artist(ab)
			preliminary_text = "Prelim. (20\%)"
		...
		if track:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/track/theta_g_times_zg/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
		else:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/all/theta_g_times_zg/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
...
def plot_zg_theta_g_square_th_mc_data(pT_lower_cut=150, pT_upper_cut=10000, track=False, zg_cut='0.05', zg_filename='zg_05', ratio_denominator="data", data=True, mc=True, theory=True, n_bins=10, y_max_limit=20, y_limit_ratio_plot=0.5):
	...
	for mc_type in ["truth"]:
		...
		if track:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/track/theta_g_square_times_zg/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
		else:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/all/theta_g_square_times_zg/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
...
def plot_zg_sqrt_theta_g_th_mc_data(pT_lower_cut=150, pT_upper_cut=10000, track=False, zg_cut='0.05', zg_filename='zg_05', ratio_denominator="data", data=True, mc=True, theory=True, n_bins=10, y_max_limit=20, y_limit_ratio_plot=0.5):
	...
	for mc_type in ["truth"]:
		...
		if track:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/track/sqrt_theta_g_times_zg/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
		else:	
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/all/sqrt_theta_g_times_zg/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
...
def plot_theta_g_th_mc_data(pT_lower_cut=150, track=False, pT_upper_cut=10000, zg_cut='0.05', zg_filename='zg_05', ratio_denominator="data", data=True, mc=True, theory=True, n_bins=10, y_max_limit=20, y_limit_ratio_plot=0.5):
	...
	for mc_type in ["truth"]:
		...
		if track:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/track/theta_g/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
		else:
			filename = "plots/" + get_version(input_analysis_file) + "/theta_g/" + mc_type + "/linear/all/theta_g/zg_cut_" + str(zg_filename) + "_pT_lower_" + str(pT_lower_cut) + "_pT_upper_" + str(pT_upper_cut) + "_ratio_over_" + ratio_denominator + "_th_" + str(theory) + "_mc_" + str(mc) + "_data_" + str(data) + ".pdf"
...
def plot_charged_theta_g_linear_plots(pT_lower_cut=150, zg_cut='0.10', zg_filename='zg_10'):
	...
	for mc_type in ["truth", "reco"]:
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.20, 0.895), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
...
def plot_softcut_theta_g_linear_plots(pT_lower_cut=150, zg_cut='0.10', zg_filename='zg_10', softcut_pTs=[2, 5]):
	...
	for mc_type in ["truth", "reco"]:
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.21, 0.91), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
...
def plot_constituent_multiplicity(pT_lower_cut=150, pT_upper_cut=20000):
	...
	for mc_label in ["truth"]:
		...
		ab = AnnotationBbox(OffsetImage(read_png(get_sample_data("/home/aashish/root/macros/MODAnalyzer/mod_logo.png", asfileobj=False)), zoom=0.15, resample=1, dpi_cor=1), (0.23, 0.90), xycoords='figure fraction', frameon=0)
		plt.gca().add_artist(ab)
		preliminary_text = "Prelim. (20\%)"
...
def plot_theta_g_vs_eta(pT_lower_cut=150, zg_cut='0.10', zg_filename='zg_10', log=False):
	...
	for mc_type in ['truth']:
		...
		for (eta_s, theta_g_s) in [ (eta_data, theta_g_data), (eta_pythias, theta_g_pythias), (eta_herwigs, theta_g_herwigs), (eta_sherpas, theta_g_sherpas) ]:
			...
			if log:
				plt.savefig("plots/" + get_version(input_analysis_file) + "/theta_g_vs_eta/log/" + mc_type + "/" + labels[counter] + "_zg_against_theta_g_pT_" + str(pT_lower_cut) + ".pdf")
			else:
				plt.savefig("plots/" + get_version(input_analysis_file) + "/theta_g_vs_eta/linear/" + mc_type + "/" + labels[counter] + "_zg_against_theta_g_pT_" + str(pT_lower_cut) + ".pdf")
