	...
	for line in lines:
		try:
			...
			if not numbers[0] == "#":
				...
				if (float(numbers[1]) > float(pT_lower_cut)):
					...
					properties['hardest_pts'].append( -1.0 )
					properties['zg_05'].append( -1.0 )
					properties['dr_05'].append( -1.0 )
					properties['mu_05'].append( -1.0 )
					properties['zg_1'].append( -1.0 )
					properties['dr_1'].append( -1.0 )
					properties['mu_1'].append( -1.0 )
					properties['zg_2'].append( -1.0 )
					properties['dr_2'].append( -1.0 )
					properties['mu_2'].append( -1.0 )

					properties['zg_05_pt_1'].append( -1.0 )
					properties['zg_1_pt_1'].append( -1.0 )
					properties['zg_2_pt_1'].append( -1.0 )

					properties['zg_05_pt_2'].append( -1.0 )
					properties['zg_1_pt_2'].append( -1.0 )
					properties['zg_2_pt_2'].append( -1.0 )

					properties['zg_05_pt_3'].append( -1.0 )
					properties['zg_1_pt_3'].append( -1.0 )
					properties['zg_2_pt_3'].append( -1.0 )

					properties['zg_05_pt_5'].append( -1.0 )
					properties['zg_1_pt_5'].append( -1.0 )
					properties['zg_2_pt_5'].append( -1.0 )

					properties['zg_05_pt_10'].append( -1.0 )
					properties['zg_1_pt_10'].append( -1.0 )
					properties['zg_2_pt_10'].append( -1.0 )

					properties['zg_charged_05'].append( -1.0 )
					properties['zg_charged_1'].append( -1.0 )
					properties['zg_charged_2'].append( -1.0 )

					properties['pTs_after_SD'].append( -1.0 )

					properties['multiplicity_before_SD'].append( -1.0 )
					properties['multiplicity_after_SD'].append( -1.0 )
					properties['jet_mass_before_SD'].append( -1.0 )
					properties['jet_mass_after_SD'].append( -1.0 )

					properties['charged_multiplicity_before_SD'].append( -1.0 )
					properties['charged_multiplicity_after_SD'].append( -1.0 )
					properties['charged_jet_mass_before_SD'].append( -1.0 )
					properties['charged_jet_mass_after_SD'].append( -1.0 )

					properties['chrg_dr_05'].append( -1.0 )
					properties['chrg_dr_1'].append( -1.0 )
					properties['chrg_dr_2'].append( -1.0 )

					properties['fractional_energy_loss'].append( -1.0 )
					properties['eta'].append( -1.0 )
...
def plot_pt(pT_lower_cut):
	...
	properties_reco = [parse_mc("/home/aashish/pythia_reco.dat", pT_lower_cut=pT_lower_cut), parse_mc("/home/aashish/herwig_reco.dat", pT_lower_cut=pT_lower_cut), parse_mc("/home/aashish/sherpa_reco.dat", pT_lower_cut=pT_lower_cut)]
	properties_truth = [parse_mc("/home/aashish/pythia_truth.dat", pT_lower_cut=pT_lower_cut), parse_mc("/home/aashish/herwig_truth.dat", pT_lower_cut=pT_lower_cut), parse_mc("/home/aashish/sherpa_truth.dat", pT_lower_cut=pT_lower_cut)]
...
def plot_zg(pT_lower_cut):
	...
	for prop_reco, prop_truth, label in zip(properties_reco, properties_truth, labels):
		...
		plt.savefig("plots/With MC/2D/zg_05.pdf")
		# plt.show()
