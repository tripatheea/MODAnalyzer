...
upper_left = (-0.08, 0.97)
upper_right = (0.77, 0.97)
mid_right = (0.80, 0.5)
...
def multi_page_log_plot_hist_templates():
	...
	for i in xrange(len(pT_boundaries) - 1):
		...
		additional_text = [ ( upper_left, 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
	...
	all_hists['frac_pT_loss'].append( MODHist(frac_pT_loss_hist, conditions=default_150_conditions, use_prescale=True, x_scale='log', x_label="Fractional $p_T$ Loss", y_label="A.U.", y_range=(0., 0.8), additional_text=additional_text, legend_location=('upper left', (0.0, 1.0)) ) ) 
	...
	additional_text = [ ( (-0.08, 0.60), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$\nAK5; $\left| \eta \\right| < 2.4$\n$p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=default_150_conditions, x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="Probability Density", y_range=(0., 1.5), legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 
	...
	# additional_text = [ ( (-0.08, 0.60), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$;\nAK5; $\left| \eta \\right| < 2.4$\n$p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	additional_text = [ ( (-0.08, 0.60), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$;\nAK5; $\left| \eta \\right| < 2.4$\n$p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=default_150_conditions, x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="Probability Density", y_range=(0., 1.5), legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.965), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} >150~\mathrm{GeV}$" ) ]
	all_hists['pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=default_150_conditions, x_scale='log', use_prescale=True, y_range=(0., 1.2), x_label="$p_T^D$", y_label="Probability Density", legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.965), 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} >150~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=default_150_conditions, x_scale='log', use_prescale=True, y_range=(0., 1.2), x_label="Track $p_T^D$", y_label="Probability Density", legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.965), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=default_150_conditions, x_scale='log', use_prescale=True, x_label="Width", y_range=(0.0, 0.95), y_label="Probability Density", legend_location=('upper left', (0., 1.0)), additional_text=additional_text ) ) 
	...
	# additional_text = [ ( (1.0, 0.965), 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	additional_text = [ ( (1.0, 0.965), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=default_150_conditions, x_scale='log', use_prescale=True, y_range=(0.0, 0.8), x_label="Track Width", y_label="Probability Density", legend_location=('upper left', (0., 1.0)), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.965), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=default_150_conditions, x_scale='log', use_prescale=True, y_range=(0.0, 0.7), x_label="Thrust", y_label="Probability Density", legend_location=('upper left', (0., 1.0)), additional_text=additional_text ) ) 
	...
	# additional_text = [ ( (1.0, 0.965), 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	additional_text = [ ( (1.0, 0.965), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=default_150_conditions, x_scale='log', use_prescale=True, y_range=(0.0, 0.6), x_label="Track Thrust", y_label="Probability Density", legend_location=('upper left', (0., 1.0)), additional_text=additional_text ) ) 
...
def multi_page_plot_hist_templates():
	...
	for i in xrange(len(pT_boundaries) - 1):
		...
		additional_text = [ ( upper_left, 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$ \n SD: $\\beta = 0; z_{\mathrm{cut}} = 0.2$" ) ]
	...
	all_hists['hardest_pT'].append( MODHist(Hist(162, 85, 1705, title="pT"), conditions=default_85_conditions, use_prescale=True, x_label="$p_T$ [GeV]", y_label="Probability Density", y_scale='log', x_range=(0, 1200), y_range=(1e-9, 1e-1), mark_regions=[(150, 1e-6, 'right', 1e-7, 25)], additional_text=additional_text ) )

	additional_text = [ ( (0.49, 0.68), 'upper left', "AK5; $\left| \eta \\right| < 2.4$ \n $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['hardest_pT'].append( MODHist(Hist(156, 150, 1710, title="pT"), conditions=default_150_conditions, use_prescale=True, x_label="$p_T$ [GeV]", y_label="Probability Density", y_scale='log', x_range=(0, 1500), y_range=(1e-9, 1e-1), additional_text=additional_text ) )

	additional_text = [ ( (0.49, 0.68), 'upper left', "AK5; $\left| \eta \\right| < 2.4$ \n $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['hardest_pT'].append( MODHist(Hist(146, 250, 1710, title="pT"), conditions=default_250_conditions, use_prescale=True, x_label="$p_T$ [GeV]", y_label="Probability Density", y_scale='log', x_range=(0, 1500), y_range=(5e-7, 1e-1), additional_text=additional_text ) )
	...
	all_hists['hardest_eta'].append( MODHist(copy.deepcopy(hardest_eta_hist), conditions=[('hardest_pT', (85, None))], use_prescale=True, x_label="$\eta$", y_label="Probability Density", x_range=(-5., 5.), y_range=(0., 0.325), mark_regions=[(-2.4, 0.20, 'right', 0.18, 0.3), (2.4, 0.15, 'left', 0.05, -0.3)], additional_text=additional_text, legend_location=('upper left', (0., 1.0) ) )) 
	...
	all_hists['mul_pre_SD'].append( MODHist(copy.deepcopy(constituent_mul_hist), conditions=default_150_conditions, use_prescale=True, x_label="Constituent Multiplicity", y_range=(0., 0.08), x_range=(0, 60), y_label="Probability Density", additional_text=additional_text, legend_location=('upper right', (1.0, 1.0)) ) ) 
	...
	additional_text = [ ( mid_right, 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$\nAK5; $\left| \eta \\right| < 2.4$\n$p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_mul_pre_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=default_150_conditions, use_prescale=True, y_range=(0, 0.09), x_label="Track Multiplicity", x_range=(0, 40), y_label="Probability Density", additional_text=additional_text, legend_location=('upper right', (1.0, 1.0)) ) ) 
	...
	additional_text = [ ( mid_right, 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['mass_pre_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=default_150_conditions, use_prescale=True, x_label="Mass [GeV]", y_label="Probability Density [$\mathrm{GeV}^{-1}$]", x_range=(0.0, 60.0), y_range=(0, 0.095), additional_text=additional_text ) ) 
	...
	additional_text = [ ( mid_right, 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$ \n AK5; $\left| \eta \\right| < 2.4$ \n $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_mass_pre_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=default_150_conditions, use_prescale=True, x_label="Track Mass [GeV]", x_range=(0.0, 35.0), y_range=(0, 0.12), y_label="Probability Density [$\mathrm{GeV}^{-1}$]", additional_text=additional_text ) ) 
	...
	additional_text = [ ( mid_right, 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_mass_post_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=default_150_conditions, use_prescale=True, x_range=(0, 35), y_range=(0.00, 0.13), x_label="Track Mass [GeV]", y_label="Probability Density [$\mathrm{GeV}^{-1}$]", legend_location=('upper right', (0.85, 1.0)), additional_text=additional_text ) ) 
