...
def multi_page_log_plot_hist_templates():
	...
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="$\\frac{p_T^D \mathrm{d} \sigma}{\sigma \mathrm{d} p_T^D}$", y_range=(0., 1.2), legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.965), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="$\\frac{p_T^D \mathrm{d} \sigma}{\sigma \mathrm{d} p_T^D}$", y_range=(0., 1.0), legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 1.0), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} >250~\mathrm{GeV}$" ) ]
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="$\\frac{p_T^D \mathrm{d} \sigma}{\sigma \mathrm{d} p_T^D}$", y_range=(0., 1.2), legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 1.0), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} >85~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="$\\frac{p_T^D \mathrm{d} \sigma}{\sigma \mathrm{d} p_T^D$", y_range=(0., 1.2), legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.965), 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="$\\frac{p_T^D \mathrm{d} \sigma}{\sigma \mathrm{d} p_T^D$", y_range=(0., 1.1), legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 1.0), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} >250~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="$\\frac{p_T^D \mathrm{d} \sigma}{\sigma \mathrm{d} p_T^D$", y_range=(0., 1.2), legend_location=('upper left', (0., 1.)), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="LHA", y_range=(0.0, 1.5), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.97), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="LHA", y_range=(0.0, 1.5), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", legend_location=('upper left', (0., 1.0)), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="LHA", y_range=(0.0, 1.5), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_range=(0.0, 1.5), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.965), 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_range=(0.0, 1.5), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", legend_location=('upper left', (0., 1.0)), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_range=(0.0, 1.5), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.6), x_label="LHA", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.6), x_label="LHA", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.6), x_label="LHA", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Width", y_range=(0.0, 1.0), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.965), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Width", y_range=(0.0, 0.85), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", legend_location=('upper left', (0., 1.0)), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Width", y_range=(0.0, 1.0), y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.0), x_label="Track Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.965), 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.85), x_label="Track Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", legend_location=('upper left', (0., 1.0)), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.0), x_label="Track Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Track Width", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e}$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.965), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.6), x_label="Thrust", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e }$", legend_location=('upper left', (0.0, 1.0)), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.965), 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.6), x_label="Track Thrust", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e }$", legend_location=('upper left', (0.0, 1.0)), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.75), x_label="Thrust", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e }$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.75), x_label="Thrust", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e }$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 250~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.75), x_label="Thrust", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e }$", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track Thrust", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e }$", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track Thrust", y_label="$\\frac{e \mathrm{d} \sigma}{\sigma \mathrm{d} e }$", additional_text=additional_text ) ) 
...
def multi_page_plot_hist_templates():
	...
	additional_text = [ ( (0.99, 0.63), 'upper right', "AK5; \left| \eta \\right| < 2.4$ \n $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['hardest_pT'].append( MODHist(Hist(240, 85, 2005, title="pT"), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="$p_T$ [GeV]", y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} p_T}$", y_scale='log', x_range=(0, 1000), y_range=(1e-9, 1e-1), additional_text=additional_text ) )
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "AK5; \left| \eta \\right| < 2.4$ \n $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['jec'].append( MODHist(copy.deepcopy(jec_hist), conditions=[('hardest_pT', (85, None)), ('hardest_eta', (-2.4, 2.4))], use_prescale=True, x_label="JEC", y_label="A.U.", x_range=(1.0, 1.15), x_scale='linear', additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "AK5; \left| \eta \\right| < 2.4$ \n $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['hardest_area'].append( MODHist(copy.deepcopy(hardest_area_hist), conditions=[('hardest_pT', (85, None)), ('hardest_eta', (-2.4, 2.4))], use_prescale=True, x_label="Jet Area", y_label="A.U.", x_range=(0.7, 0.9), x_scale='linear', additional_text=additional_text ) ) 
	...
	all_hists['hardest_eta'].append( MODHist(copy.deepcopy(hardest_eta_hist), conditions=[('hardest_pT', (85, None))], use_prescale=True, x_label="$\eta$", y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} \eta}$", x_range=(-5., 5.), y_range=(0., 0.325), mark_regions=[(-2.4, 0.20, 'right', 0.05), (2.4, 0.20, 'left', 0.05)], additional_text=additional_text, legend_location=(0., 1.0) ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "AK5; \left| \eta \\right| < 2.4$ \n $p_T^{\mathrm{jet}} > 85~\mathrm{GeV}$" ) ]
	all_hists['hardest_phi'].append( MODHist(copy.deepcopy(hardest_phi_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="$\phi$", x_range=(0, 2 * np.pi), y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} \phi}$", y_range=(0.0, 0.35), additional_text=additional_text, axes_label_pi=True ) )
	...
	all_hists['mul_pre_SD'].append( MODHist(copy.deepcopy(constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Constituent Multiplicity", x_range=(0, 60), y_range=(0., 0.10), y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} N}$", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 

	additional_text = [ ( (0.985, 0.60), 'upper right', "$p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['mul_pre_SD'].append( MODHist(copy.deepcopy(constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Constituent Multiplicity", y_range=(0., 0.065), x_range=(0, 60), y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} N}$", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 
	...
	all_hists['track_mul_pre_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, y_range=(0, 0.085), x_label="Track Constituent Multiplicity", x_range=(0, 40), y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} N}$", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 
	...
	additional_text = [ ( (0.99, 0.70), 'upper right', "\\textbf{Track Only} \n $p_T^{\mathrm{PFC}} > 1.0~\mathrm{GeV}$; AK5 \n $\left| \eta \\right| < 2.4$; $p_T^{\mathrm{jet}} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_range=(0.02, 1.2), x_label="Track $p_T^D$", y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} p_T^D}$", additional_text=additional_text ) ) 
	...
	all_hists['mass_pre_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Mass [GeV]", y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} m}$", x_range=(0.0, 60.0), y_range=(0, 0.065), additional_text=additional_text ) ) 
	...
	all_hists['track_mass_pre_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Track Mass [GeV]", x_range=(0.0, 35.0), y_range=(0, 0.09), y_label="$\\frac{1}{\sigma}\\frac{\mathrm{d} \sigma}{\mathrm{d} m}$", additional_text=additional_text ) ) 
...
def two_dim_hists():
	...
	zg_hist = Hist2D(50, 0.0, 0.5, 50, 0.0, 1.0)
