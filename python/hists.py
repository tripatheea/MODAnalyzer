...
def multi_page_log_plot_hist_templates():
	...
	for i in range(len(pT_boundaries) - 1):
		...
		all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, x_label="$p_T^D$", y_label="A.U.", y_range=(0., 1.2), additional_text=additional_text ) ) 

		additional_text = [ ( (-0.08, 1.0), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, x_label="Track $p_T^D$", y_label="A.U.", y_range=(0., 1.2), additional_text=additional_text ) ) 



		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, x_label="$p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 
		...
		additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, y_range=(0.0, 1.5), x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', y_range=(0.0, 1.5), use_prescale=False, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 



		additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', y_range=(0.0, 1.6), use_prescale=False, x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 




		additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, y_range=(0.0, 1.0), x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, y_range=(0.0, 1.0), x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 


		additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', y_range=(0.0, 1.0), use_prescale=False, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 




		additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, y_range=(0.0, 0.8), x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, y_range=(0.0, 0.6), x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 


		additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', y_range=(0.0, 0.75), use_prescale=False, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], x_scale='log', use_prescale=False, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 1.0), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >85~\mathrm{GeV}$" ) ]
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="A.U.", y_range=(0., 1.2), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 1.0), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >150~\mathrm{GeV}$" ) ]
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="A.U.", y_range=(0., 1.2), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 1.0), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >250~\mathrm{GeV}$" ) ]
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="A.U.", y_range=(0., 1.2), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 1.0), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >85~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", y_range=(0., 1.2), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 1.0), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >150~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", y_range=(0., 1.2), additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 1.0), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >250~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", y_range=(0., 1.2), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >85~\mathrm{GeV}$" ) ]
	all_hists['pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >150~\mathrm{GeV}$" ) ]
	all_hists['pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >250~\mathrm{GeV}$" ) ]
	all_hists['pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="$p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >85~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >150~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 


	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} >250~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="LHA", y_range=(0.0, 1.5), y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="LHA", y_range=(0.0, 1.5), y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="LHA", y_range=(0.0, 1.5), y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_range=(0.0, 1.5), y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_range=(0.0, 1.5), y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_range=(0.0, 1.5), y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.6), x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.6), x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.6), x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Width", y_range=(0.0, 1.0), y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Width", y_range=(0.0, 1.0), y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Width", y_range=(0.0, 1.0), y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.0), x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.0), x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, y_range=(0.0, 1.0), x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.8), x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.6), x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.8), x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.6), x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.6), x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.6), x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.75), x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.75), x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, y_range=(0.0, 0.75), x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], x_scale='log', use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], x_scale='log', use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 



	additional_text = [ ( (-0.08, 0.98), 'upper left', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], x_scale='log', use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 
...
def multi_page_plot_hist_templates():
	...
	for i in range(len(pT_boundaries) - 1):
		...
		additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['hardest_pT'].append( MODHist(Hist(25, pT_boundaries[i], pT_boundaries[i + 1]), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="$p_T$", y_label="A.U.", y_scale='log', x_range=(pT_boundaries[i], pT_boundaries[i + 1]), y_range=(5e-3, 5e-1), additional_text=additional_text ) ) 



		additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['uncor_hardest_pT'].append( MODHist(Hist(25, pT_boundaries[i], pT_boundaries[i + 1]), conditions=[('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1])), ('hardest_eta', (-2.4, 2.4))], use_prescale=False, x_label="$p_T$", y_label="A.U.", x_scale='linear', y_scale='log', x_range=(pT_boundaries[i], pT_boundaries[i + 1]), y_range=(5e-3, 5e-1), additional_text=additional_text ) ) 
		...
		additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['pT_after_SD'].append( MODHist(Hist(25, pT_boundaries[i], pT_boundaries[i + 1]), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="$p_T$", y_label="A.U.", y_scale='log', x_range=(pT_boundaries[i], pT_boundaries[i + 1]), y_range=(1e-3, 1e1), additional_text=additional_text ) ) 




		additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['hardest_eta'].append( MODHist(copy.deepcopy(hardest_eta_hist), conditions=[('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="$\eta$", y_label="A.U.", x_range=(-5., 5.), y_range=[(0., 0.35), (0., 0.35), (0., 0.38), (0., 0.38)][i], mark_regions=[(-2.4, 0.24, 'right', 0.20), (2.4, 0.24, 'left', 0.20)], additional_text=additional_text ) ) 




		additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['hardest_phi'].append( MODHist(copy.deepcopy(hardest_phi_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="$\phi$", x_range=(0, 2 * np.pi), y_range=[0.0, 0.40], y_label="A.U.", additional_text=additional_text, axes_label_pi=True ) ) 
		...
		all_hists['mul_pre_SD'].append( MODHist(copy.deepcopy(constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Constituent Multiplicity", y_label="A.U.", x_range=(0, 45), y_range=(0, 0.11), additional_text=additional_text, legend_location=[(0.96, 1.0), (0.94, 1.0), (0.94, 1.0), (0.94, 1.0)][i] ) ) 

		additional_text = [ ( (1.0, 0.68), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_mul_pre_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Track Constituent Multiplicity", x_range=(0, 45), y_range=(0, 0.11), y_label="A.U.", additional_text=additional_text, legend_location=[(0.96, 1.0), (0.94, 1.0), (0.94, 1.0), (0.94, 1.0)][i] ) ) 
		...
		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_mul_post_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Track Constituent Multiplicity", y_label="A.U.", additional_text=additional_text ) ) 
		...
		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="$p_T^D$", y_label="A.U.", y_range=(0, 10), additional_text=additional_text, legend_location=[(0.96, 1.0), (0.94, 1.0), (0.94, 1.0), (0.94, 1.0)][i] ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Track $p_T^D$", y_label="A.U.", y_range=(0, 10), additional_text=additional_text, legend_location=[(0.96, 1.0), (0.94, 1.0), (0.94, 1.0), (0.94, 1.0)][i] ) ) 
		...
		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 
		...
		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['mass_pre_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Mass [GeV]", y_label="A.U.", x_range=[(0.0, 40.0), (0.0, 40.0), (0.0, 50.0), (0.0, 70.0)][i], y_range=[(0, 0.12), (0, 0.11), (0, 0.08), (0, 0.10)][i], additional_text=additional_text, legend_location=[(0.96, 1.0), (0.94, 1.0), (0.94, 1.0), (0.94, 1.0)][i] ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_mass_pre_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Hardest Track Jet Mass [GeV]", y_label="A.U.", x_range=[(0.0, 30.0), (0.0, 30.0), (0.0, 40.0), (0.0, 40.0)][i], y_range=[(0, 0.12), (0, 0.11), (0, 0.08), (0, 0.10)][i], additional_text=additional_text, legend_location=[(0.96, 1.0), (0.94, 1.0), (0.94, 1.0), (0.94, 1.0)][i] ) ) 




		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['mass_post_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Mass [GeV]", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_mass_post_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Hardest Track Jet Mass [GeV]", y_label="A.U.", additional_text=additional_text ) ) 



		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="LHA", y_label="A.U.", y_range=[(0., 4.5), (0., 4.5), (0., 4.5), (0., 4.5)][i], additional_text=additional_text, legend_location=[(0.96, 1.0), (0.94, 1.0), (0.94, 1.0), (0.94, 1.0)][i] ) )  

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Track LHA", y_label="A.U.", y_range=[(0., 4.5), (0., 4.5), (0., 4.5), (0., 4.5)][i], additional_text=additional_text, legend_location=[(0.96, 1.0), (0.94, 1.0), (0.94, 1.0), (0.94, 1.0)][i] ) ) 



		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 




		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 


		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 




		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 


		additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

		additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} \in [" + str(pT_boundaries[i]) + ", " + str(pT_boundaries[i + 1]) + "]~\mathrm{GeV}$" ) ]
		all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], use_prescale=False, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 
	...
	all_hists['hardest_pT'].append( MODHist(Hist(200, 5, 2005, title="pT"), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="$p_T$ [GeV]", y_label="A.U.", y_scale='log', x_range=(0, 1000), y_range=(1e-9, 1e-1), additional_text=additional_text ) )

	additional_text = [ ( (0.49, 0.68), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['hardest_pT'].append( MODHist(Hist(200, 0, 2000, title="pT"), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="$p_T$ [GeV]", y_label="A.U.", y_scale='log', x_range=(0, 1000), y_range=(1e-9, 1e-1), additional_text=additional_text ) )

	additional_text = [ ( (0.49, 0.68), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['hardest_pT'].append( MODHist(Hist(200, 0, 2000, title="pT"), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="$p_T$ [GeV]", y_label="A.U.", y_scale='log', x_range=(0, 1000), y_range=(5e-7, 1e-1), additional_text=additional_text ) )




	additional_text = [ ( (0.47, 0.68), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['uncor_hardest_pT'].append( MODHist(Hist(200, 5, 2005, title="pT"), conditions=[('hardest_pT', (85, None)), ('hardest_eta', (-2.4, 2.4))], use_prescale=True, x_label="$p_T$ [GeV]", y_label="A.U.", x_scale='linear', y_scale='log', x_range=(0, 1000), y_range=(1e-9, 1e-1), additional_text=additional_text ) )

	additional_text = [ ( (0.47, 0.68), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['uncor_hardest_pT'].append( MODHist(Hist(200, 0, 2000, title="pT"), conditions=[('hardest_pT', (150, None)), ('hardest_eta', (-2.4, 2.4))], use_prescale=True, x_label="$p_T$ [GeV]", y_label="A.U.", x_scale='linear', y_scale='log', x_range=(0, 1000), y_range=(1e-9, 1e-1), additional_text=additional_text ) )

	additional_text = [ ( (0.47, 0.68), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['uncor_hardest_pT'].append( MODHist(Hist(200, 0, 2000, title="pT"), conditions=[('hardest_pT', (250, None)), ('hardest_eta', (-2.4, 2.4))], use_prescale=True, x_label="$p_T$ [GeV]", y_label="A.U.", x_scale='linear', y_scale='log', x_range=(0, 1000), y_range=(5e-7, 1e-1), additional_text=additional_text ) )
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['hardest_eta'].append( MODHist(copy.deepcopy(hardest_eta_hist), conditions=[('hardest_pT', (85, None))], use_prescale=True, x_label="$\eta$", y_label="A.U.", x_range=(-5., 5.), y_range=(0., 0.35), mark_regions=[(-2.4, 0.24, 'right', 0.20), (2.4, 0.24, 'left', 0.20)], additional_text=additional_text ) ) 

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['hardest_eta'].append( MODHist(copy.deepcopy(hardest_eta_hist), conditions=[('hardest_pT', (150, None))], use_prescale=True, x_label="$\eta$", y_label="A.U.", x_range=(-5., 5.), y_range=(0., 0.40), mark_regions=[(-2.4, 0.24, 'right', 0.20), (2.4, 0.24, 'left', 0.20)], additional_text=additional_text ) ) 


	additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['hardest_eta'].append( MODHist(copy.deepcopy(hardest_eta_hist), conditions=[('hardest_pT', (250, None))], use_prescale=True, x_label="$\eta$", y_label="A.U.", x_range=(-5., 5.), y_range=(0., 0.50), mark_regions=[(-2.4, 0.28, 'right', 0.23), (2.4, 0.28, 'left', 0.23)], additional_text=additional_text ) ) 
	...
	additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['hardest_phi'].append( MODHist(copy.deepcopy(hardest_phi_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="$\phi$", x_range=(0, 2 * np.pi), y_label="A.U.", y_range=(0.0, 0.5), additional_text=additional_text, axes_label_pi=True ) )

	additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['hardest_phi'].append( MODHist(copy.deepcopy(hardest_phi_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="$\phi$", x_range=(0, 2 * np.pi), y_label="A.U.", y_range=(0.0, 0.3), additional_text=additional_text, axes_label_pi=True ) )


	additional_text = [ ( (-0.08, 0.98), 'upper left', "$ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['hardest_phi'].append( MODHist(copy.deepcopy(hardest_phi_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="$\phi$", x_range=(0, 2 * np.pi), y_label="A.U.", y_range=(0.0, 0.5), additional_text=additional_text, axes_label_pi=True ) )
	...
	all_hists['mul_pre_SD'].append( MODHist(copy.deepcopy(constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Constituent Multiplicity", x_range=(0, 50), y_range=(0., 0.10), y_label="A.U.", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 

	additional_text = [ ( (0.995, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['mul_pre_SD'].append( MODHist(copy.deepcopy(constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Constituent Multiplicity", y_range=(0., 0.08), x_range=(0, 50), y_label="A.U.", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 

	additional_text = [ ( (0.995, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['mul_pre_SD'].append( MODHist(copy.deepcopy(constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Constituent Multiplicity", x_range=(0, 50), y_range=(0., 0.10), y_label="A.U.", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 




	additional_text = [ ( (0.995, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_mul_pre_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, y_range=(0, 0.10), x_label="Track Constituent Multiplicity", x_range=(0, 50), y_label="A.U.", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 

	additional_text = [ ( (0.995, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_mul_pre_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, y_range=(0, 0.08), x_label="Track Constituent Multiplicity", x_range=(0, 50), y_label="A.U.", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 

	additional_text = [ ( (0.995, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_mul_pre_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, y_range=(0, 0.10), x_label="Track Constituent Multiplicity", x_range=(0, 50), y_label="A.U.", additional_text=additional_text, legend_location=(1.0, 1.0) ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['mul_post_SD'].append( MODHist(copy.deepcopy(constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Constituent Multiplicity", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_mul_post_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Track Constituent Multiplicity", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_mul_post_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Track Constituent Multiplicity", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_mul_post_SD'].append( MODHist(copy.deepcopy(track_constituent_mul_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Track Constituent Multiplicity", y_label="A.U.", additional_text=additional_text ) ) 
	...
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="$p_T^D$", y_label="A.U.", y_range=(0, 10), additional_text=additional_text ) ) 

	additional_text = [ ( (0.99, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="$p_T^D$", y_label="A.U.", y_range=(0, 10), additional_text=additional_text ) ) 


	additional_text = [ ( (0.99, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="$p_T^D$", y_label="A.U.", y_range=(0, 10), additional_text=additional_text ) ) 
	...
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (0.99, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (0.99, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_pre_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="$p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_pT_D_post_SD'].append( MODHist(copy.deepcopy(pT_D_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Track $p_T^D$", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['mass_pre_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Mass [GeV]", y_label="A.U.", x_range=(0.0, 40.0), y_range=(0, 0.11), additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['mass_pre_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Mass [GeV]", y_label="A.U.", x_range=(0.0, 60.0), y_range=(0, 0.08), additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['mass_pre_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Mass [GeV]", y_label="A.U.", x_range=(0.0, 80.0), y_range=(0, 0.09), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_mass_pre_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Track Mass [GeV]", x_range=(0.0, 40.0), y_range=(0, 0.11), y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_mass_pre_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Track Mass [GeV]", x_range=(0.0, 35.0), y_range=(0, 0.08), y_label="A.U.", additional_text=additional_text ) ) 


	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_mass_pre_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Track Mass [GeV]", x_range=(0.0, 40.0), y_range=(0, 0.09), y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['mass_post_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Mass [GeV]", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['mass_post_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Mass [GeV]", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['mass_post_SD'].append( MODHist(copy.deepcopy(mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Mass [GeV]", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_mass_post_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Hardest Track Jet Mass [GeV]", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_mass_post_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Hardest Track Jet Mass [GeV]", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_mass_post_SD'].append( MODHist(copy.deepcopy(track_mass_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Hardest Track Jet Mass [GeV]", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (0.99, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="LHA", y_label="A.U.", y_range=(0., 3.5), additional_text=additional_text ) ) 

	additional_text = [ ( (0.99, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="LHA", y_label="A.U.", y_range=(0., 4.0), additional_text=additional_text ) ) 

	additional_text = [ ( (0.99, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="LHA", y_label="A.U.", y_range=(0., 6.0), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Track LHA", y_label="A.U.", y_range=(0., 3.5), additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Track LHA", y_label="A.U.", y_range=(0., 4.0), additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_pre_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Track LHA", y_label="A.U.", y_range=(0., 6.0), additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="LHA", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 


	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_LHA_post_SD'].append( MODHist(copy.deepcopy(lha_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Track LHA", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_width_pre_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Width", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_width_post_SD'].append( MODHist(copy.deepcopy(width_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Hardest Track Jet Width", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_pre_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 




	additional_text = [ ( (1.0, 0.70), 'upper.right', "$\mathrm{PFC}~p_T > 0.5~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "$\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Thrust", y_label="A.U.", additional_text=additional_text ) ) 
	...
	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 

	additional_text = [ ( (1.0, 0.70), 'upper right', "\\textbf{Track Only} \n $\mathrm{PFC}~p_T > 1.0~\mathrm{GeV}$ \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	all_hists['track_thrust_post_SD'].append( MODHist(copy.deepcopy(thrust_hist), conditions=[('hardest_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], use_prescale=True, x_label="Hardest Track Jet Thrust", y_label="A.U.", additional_text=additional_text ) ) 
...
def get_pfc_hists():
	...
	for i in range(len(pT_boundaries) - 1):
		...
		pfc_hists['pfc_pT'].append( MODHist(Hist(25, 0, 5), conditions=[('jet_eta', (-2.4, 2.4)), ('hardest_pT', (pT_boundaries[i], pT_boundaries[i + 1]))], mark_regions=[1.0], use_prescale=False, x_label="Charged PFC $p_T$ [GeV]", y_label="A.U.", x_range=(0, 5), additional_text=additional_text ) ) 


	additional_text = [ ( (0.50, 0.70), 'upper left', "Charged PFCs \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 85~\mathrm{GeV}$" ) ]
	pfc_hists['pfc_pT'].append( MODHist(Hist(25, 0, 5), conditions=[('jet_eta', (-2.4, 2.4)), ('hardest_pT', (85, None))], mark_regions=[1.0], use_prescale=True, x_label="Charged PFC $p_T$ [GeV]", y_label="A.U.", x_range=(0, 5), additional_text=additional_text ) ) 

	additional_text = [ ( (0.50, 0.70), 'upper left', "Charged PFCs \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 150~\mathrm{GeV}$" ) ]
	pfc_hists['pfc_pT'].append( MODHist(Hist(25, 0, 5), conditions=[('jet_eta', (-2.4, 2.4)), ('hardest_pT', (150, None))], mark_regions=[1.0], use_prescale=True, x_label="Charged PFC $p_T$ [GeV]", y_label="A.U.", x_range=(0, 5), additional_text=additional_text ) ) 

	additional_text = [ ( (0.50, 0.70), 'upper left', "Charged PFCs \n $ \mathrm{Anti-}k_{t}\mathrm{:}~R = 0.5; \left| \eta \\right| < 2.4$ \n Hardest Jet $p_{T} > 250~\mathrm{GeV}$" ) ]
	pfc_hists['pfc_pT'].append( MODHist(Hist(25, 0, 5), conditions=[('jet_eta', (-2.4, 2.4)), ('hardest_pT', (250, None))], mark_regions=[1.0], use_prescale=True, x_label="Charged PFC $p_T$ [GeV]", y_label="A.U.", x_range=(0, 5), additional_text=additional_text ) ) 
